...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initTransportModal() {
        ...
        const openButtons = [
            document.getElementById('open-transport-modal'),
            document.getElementById('open-transport-modal-2'), // ID do novo botão
            document.getElementById('open-transport-search'),
            document.getElementById('open-transport-filters')
        ].filter(Boolean); // Filtra para remover nulos se algum ID não existir
    
        const closeButton = document.getElementById('close-transport-modal');
    
        if (transportModal && openButtons.length > 0 && closeButton) {
            // Eventos para abrir o modal
            openButtons.forEach(button => {
                button.addEventListener('click', (e) => {
                    e.preventDefault();
                    transportModal.classList.add('visible');
            ...
            closeButton.addEventListener('click', () => {
                transportModal.classList.remove('visible');
    ...
    function openModal(modal, closeButton) {
        modal.classList.add('visible'); // Usando a classe 'visible'
        document.body.style.overflow = 'hidden';
    ...
    function closeModal(modal) {
        modal.classList.remove('visible'); // Usando a classe 'visible'
        document.body.style.overflow = '';
    }
