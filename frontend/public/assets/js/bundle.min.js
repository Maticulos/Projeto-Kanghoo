...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initBillingToggle() {
        ...
        const prices = {
            basic: { monthly: 189.90, annualMonthly: 161.415 },
            premium: { monthly: 294.90, annualMonthly: 250.665 }
        };
            ...
            cards.forEach(card => {
                ...
                if (mode === 'monthly') {
                    ...
                    if (equivBox) {
                        ...
                        if (savingsEl) savingsEl.textContent = `Economize ${currencyBRL(savings)} (${savingsPercent}% OFF)`;
                    }
                }
            });
        };
...
class CacheManager {
    ...
    async preloadCriticalData() {
        ...
        // FIX: Check for token before preloading protected endpoints
...
// Exportar para uso em módulos - REMOVIDO PARA EVITAR ERROS NO BROWSER
