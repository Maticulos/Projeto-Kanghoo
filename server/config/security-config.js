...
const securityConfig = {
    ...
    securityHeaders: {
        ...
        'Content-Security-Policy': [
            ...
            "img-src 'self' data: https: http://localhost:* https://*.openstreetmap.org https://*.tile.openstreetmap.org",
            "connect-src 'self' https://router.project-osrm.org https://nominatim.openstreetmap.org https://viacep.com.br",
